...
export default function App() {
  ...
  const [totalboundaries, setTotalBoundaries] = useState(license.features.length)
  ...
  return (
    ...
    >
      <MapContainer style={{height: '100%', width: '100%'}} center={[0.142, 34.66]} zoom={10} scrollWheelZoom={true}>
